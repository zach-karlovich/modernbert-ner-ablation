...
**Last updated:** 2026-04-06 (aligned with [results/results_summary.md](results/results_summary.md)).
...
| ModernBERT-base + document context + CRF (`doc_5e5_bs4`) | 0.9005 ± 0.0050 | 0.8860 ± 0.0065 |

### Per-entity F1

| Entity | BERT                | ModernBERT (sentence, config 0) | ModernBERT (document) | ModernBERT (sentence + CRF G) | ModernBERT (document + CRF `doc_5e5_bs4`) |
| ------ | ------------------- | ------------------------------- | --------------------- | ----------------------------- | ----------------------------------------- |
| PER    | 0.9622 ± 0.0019     | 0.9528 ± 0.0035                 | **0.9808** ± 0.0022   | 0.9544 ± 0.0013               | 0.9638 ± 0.0063                           |
| ORG    | **0.8975** ± 0.0037 | 0.8458 ± 0.0030                 | 0.8942 ± 0.0041       | 0.8690 ± 0.0029               | 0.8695 ± 0.0078                           |
| LOC    | **0.9305** ± 0.0025 | 0.9100 ± 0.0021                 | 0.9268 ± 0.0016       | 0.9201 ± 0.0025               | 0.9145 ± 0.0021                           |
| MISC   | 0.7973 ± 0.0021     | 0.7796 ± 0.0045                 | **0.7999** ± 0.0008   | 0.8012 ± 0.0035               | 0.7963 ± 0.0165                           |
...
| 4. Document context, CRF head    | `uv run python scripts/train_modernbert_doc_crf_ner.py` | `results/modernbert_doc_crf_ner_config_doc_0.csv`, `modernbert_doc_crf_ner_config_doc_5e5_bs4.csv` (and paired `*.json` manifests); logs `train_mbert_doc_crf_doc0.txt`, `train_mbert_doc_crf_doc5e5.txt` |
